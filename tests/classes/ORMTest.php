...
class ORMTest extends PHPUnit_Framework_TestCase
{
	...
	public static function setUpBeforeClass() {
		...
		self::$author   = new \vakata\database\orm\Table(self::$db, 'author');
		self::$tag      = new \vakata\database\orm\Table(self::$db, 'tag');
		self::$book_tag = new \vakata\database\orm\Table(self::$db, 'book_tag');
		self::$book     = new \vakata\database\orm\Table(self::$db, 'book');
